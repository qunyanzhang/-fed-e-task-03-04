<template>
  <div>
    ...
    >
      ...
      <h1 class="project-name">Micky</h1>
      <h2 class="project-tagline">欢迎来到Micky的个人博客。</h2>
      <a
        :href="'https://github.com/qunyanzhang'"
        class="btn"
        target="_blank"
        >GitHub主页</a
      >
        ...
        <el-row>
          ...
          <el-col :span="4" :offset="8" style="text-align: right;">
            ...
            <div style="color:#606266;">
              <i class="el-icon-location"></i>&nbsp;HangZhou
              <br />
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center;">
            <img
              v-popover:bigAvatar
              src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3782128483,794367969&fm=26&gp=0.jpg"
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp; Qunyan
              <br />
              <i class="el-icon-location"></i>&emsp; 杭州
              <br />
              <img src="https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3782128483,794367969&fm=26&gp=0.jpg" style="width: 200px;height: 200px;" />
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
